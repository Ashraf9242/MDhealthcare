    ...
    modal.innerHTML = `
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Detailed information about ${serviceName} services will be displayed here.</p>
                <p>Our expert team provides comprehensive care with the latest medical technologies.</p>
                <button class="btn btn-primary" onclick="scrollToSection('appointments')">
                    Book Appointment
                </button>
            </div>
        </div>
...
function showBookingModal(doctorName, specialty) {
    ...
    modal.innerHTML = `
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Please fill out the appointment form below or scroll to the appointments section.</p>
                <button class="btn btn-primary" onclick="scrollToSection('appointments')">
    ...
    // Apply same modal styles as service modal
    modal.style.cssText = `
        position: fixed;
        top: 0;
        left: 0;
